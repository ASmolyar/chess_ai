...
public class Search {
    ...
    public Search() {
        ...
        this.evaluator = new TuringEval(); // Default evaluator
        clear();
    }
    ...
    /**
     * Set the evaluator to use for position evaluation.
     */
    ...
    private int quiescence(Position pos, int alpha, int beta, int ply) {
        ...
        // Delta pruning
        int delta = evaluator.getPieceValue(QUEEN) + 200;
        ...
        for (int i = 0; i < moves.size(); i++) {
            ...
            int captureValue = evaluator.getPieceValue(pieceType(captured));
